    ...
    return <LoadingPlaneStyle>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" id="plane" className="plane" viewBox="0 0 104 47" x="0" y="0" width="104" height="47" background-color="#ffffff00">
            <g id="avion">
                ...
                <path d="M23 36C28 37 69 43 80 40 88 38 98 34 102 29 82 32 22 36 23 36Z" stroke="#ffffff00" strokeWidth="1" fill="#12549b" />
                <path d="M42 39C48 40 60 40 67 40 71 32 72 26 72 26L44 29C44 29 44 35 42 39Z" stroke="#ffffff00" strokeWidth="1" fill="#0c3b4d" />
                <path d="M7 16C7 16 9 20 10 22 13 27 16 13 16 13L7 16Z" stroke="#ffffff00" strokeWidth="1" fill="#0355ad" />
                <path d="M40 29C40 29 41 34 34 42 27 51 48 46 58 39 74 28 72 25 72 25L40 29Z" stroke="#ffffff00" strokeWidth="1" fill="#0359b5" />
                <path d="M5 14C5 14 6 15 3 19 1 22 10 20 13 17 19 11 17 11 17 11L5 14Z" stroke="#ffffff00" strokeWidth="1" fill="#0b4d93" />
